...
-- AddForeignKey
ALTER TABLE "Orders" ADD CONSTRAINT "Orders_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "EventType"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PaymentTransaction" ADD CONSTRAINT "PaymentTransaction_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "Orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
